...
local EffectRemote = ReplicatedStorage:WaitForChild("EffectRemote") :: RemoteEvent
...
return function(self, bool, character, skillModel)
    if bool then
        ...
        EffectRemote:FireServer(skillModel.Reactor.FieldExplosion, true)
        ...
        EffectRemote:FireServer(skillModel.Reactor.FieldExplosion, false)
