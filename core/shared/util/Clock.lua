...
local SyncEvent, DelayedRequestFunction, Manager

if RunService:IsClient() and RunService:IsServer() then
	-- Solo test mode
    SyncEvent = Instance.new("RemoteEvent")
    SyncEvent.Name = "TimeSyncEvent"
    SyncEvent.Parent = ReplicatedStorage

    DelayedRequestFunction = Instance.new("RemoteFunction")
    DelayedRequestFunction.Name = "DelayedRequestEvent"
    DelayedRequestFunction.Parent = ReplicatedStorage
...
elseif RunService:IsClient() then
	-- Client
    SyncEvent = ReplicatedStorage:WaitForChild("TimeSyncEvent")
    DelayedRequestFunction = ReplicatedStorage:WaitForChild("DelayedRequestEvent")
